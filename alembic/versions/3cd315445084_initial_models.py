...
Revision ID: 3cd315445084
Revises: c65e9acf6429
Create Date: 2025-09-27 00:01:14.794134
...
revision: str = '3cd315445084'
down_revision: Union[str, Sequence[str], None] = 'c65e9acf6429'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['symbol_id'], ['symbols.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', 'symbol_id'),
    sa.UniqueConstraint('symbol_id', 'date', name='uq_prices_symbol_date'),
